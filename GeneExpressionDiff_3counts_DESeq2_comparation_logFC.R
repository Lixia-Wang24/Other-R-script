...
cor_pearson <- cor(combined[, c("log2FC_HTSeq", "log2FC_featureCounts", "log2FC_Salmon")], method = "pearson")
cor_spearman <- cor(combined[, c("log2FC_HTSeq", "log2FC_featureCounts", "log2FC_Salmon")], method = "spearman")
...
feature_Salmon_union_spearman <- cor(feature_Salmon_union[, c("log2FC_Salmon", "log2FC_featureCounts")], method = "pearson")
...
feature_Salmon_inter_spearman <- cor(feature_Salmon_inter[, c("log2FC_Salmon", "log2FC_featureCounts")], method = "pearson")
